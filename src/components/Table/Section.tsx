...
export default function Section(props: sectionProps) {
  ...
  return (
    <div className="w-full flex flex-col h-[calc(100vh-225px)] bg-[#0b0c10] rounded-2xl border border-white/20 overflow-hidden">
          ...
          {["New Pairs", "Final Stretch", "Migrated"].map((tab) => {
            ...
            return (
              ...
              >
                ...
                {/* underline */}
                <div
                  className={`h-[2px] w-full mt-1 transition-all ${
      ...
      {/* HEADER  */}
      <div className="hidden xl:flex items-center justify-between px-3 py-2 text-white bg-[#111217] border-b border-white/10">
      ...
      {props.loading ? (
        ...
        <div className="flex flex-col w-full h-full overflow-y-auto custom-scrollbar bg-[#111217]">
